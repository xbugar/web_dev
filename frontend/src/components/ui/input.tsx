        ...
        return (
            <div className="flex relative gap-2 items-center">
                <input
                    ...
                    // data-slot="input"
                    className={cn(
                        "file:text-foreground placeholder:text-text-secondary-white selection:bg-none selection:text-primary-foreground border-0 border-b-2 border-white rounded-none bg-transparent [&:not(:placeholder-shown)]:bg-none flex h-9 w-full min-w-0 px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm pr-10",
