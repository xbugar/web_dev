        ...
        <Form {...form}>
            ...
            >
                ...
                <div className="flex flex-col items-center gap-5">
                    ...
                    <div className="inline-flex w-full gap-5 justify-between">
                        <div className="text-white-text-secondary">Send email confirmation</div>
                        <Switch
                            checked={form.watch('withEmail')}
                            onCheckedChange={checked => form.setValue('withEmail', checked)}
                        />
                    </div>
                </div>
